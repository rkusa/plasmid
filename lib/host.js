...
Host.prototype.use = function(plugin) {
  plugin(this)
}
...
Host.prototype.set = function(key, value, ns) {
  this.state.set(ns || '~', key, value)
  this.emit('set', key, value, ns || '~')
}
